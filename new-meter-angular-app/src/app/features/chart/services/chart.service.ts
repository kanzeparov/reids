...
import { ChartActionType } from '@features/chart/models/chart-action.model';
import { ChartSeriesData, ChartSeriesModel, ChartPointData } from '@features/chart/models/chart-data.model';
import { ChartAction } from '@features/chart/models/chart-action.model';
...
export class ChartService {
  ...
  private updatePoints(seriesModel: ChartSeriesModel) {
    seriesModel.points.forEach((newPoint: ChartPointData, index: number) => {
      ...
      const pointIndex = seriesModel.pointIndexes[index];
