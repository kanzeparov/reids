...
export class ChannelsStatusService {
  ...
  getInitialStatus(isSender: boolean, channel: ApiChannelsListItem) {
    return isSender ?
      this.getInitialSenderStatus(channel) :
      this.getInitialReceiverStatus(channel);
  }

  private getInitialReceiverStatus(channel: ApiChannelsListItem): ReceiverChannelStatus {
  ...
  private getInitialSenderStatus(channel: ApiChannelsListItem): SenderChannelStatus {
    if (channel.state === ApiChannelState.Open) {
